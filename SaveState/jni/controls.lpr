...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 02/10/2021 18:18:44]
...
{ Class:     org_lamw_savestate_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/savestate/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_savestate_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_savestate_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_savestate_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_savestate_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_savestate_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_savestate_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_savestate_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_savestate_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_savestate_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_savestate_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_savestate_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_savestate_Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_savestate_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_savestate_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_savestate_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_savestate_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_savestate_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_savestate_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_savestate_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_savestate_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_savestate_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_savestate_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_savestate_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_savestate_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_savestate_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_savestate_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_savestate_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_savestate_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_savestate_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_savestate_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_savestate_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_savestate_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_savestate_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_savestate_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_savestate_Controls_pOnRunOnUiThread',
  pOnClickWidgetItem name 'Java_org_lamw_savestate_Controls_pOnClickWidgetItem',
  pOnClickImageItem name 'Java_org_lamw_savestate_Controls_pOnClickImageItem',
  pOnClickCaptionItem name 'Java_org_lamw_savestate_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_org_lamw_savestate_Controls_'
    +'pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_org_lamw_savestate_Controls_'
    +'pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_org_lamw_savestate_Controls_'
    +'pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_savestate_Controls_'
    +'pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_savestate_Controls_'
    +'pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_org_lamw_savestate_Controls_'
    +'pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_savestate_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_savestate_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_savestate_Controls_'
    +'pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_savestate_Controls_'
    +'pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_savestate_Controls_'
    +'pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_savestate_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.savestate';
  gjClassName:= 'org/lamw/savestate/Controls';
