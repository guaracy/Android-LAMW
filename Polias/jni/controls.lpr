...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 03/11/2021 23:50:41]
...
{ Class:     org_lamw_polias_Controls
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/polias/Controls');
  end;
...
exports
  ...
  pOnDrawingViewTouch name 'Java_org_lamw_polias_Controls_pOnDrawingViewTouch',
  pOnDrawingViewDraw name 'Java_org_lamw_polias_Controls_pOnDrawingViewDraw',
  pOnDrawingViewSizeChanged name 'Java_org_lamw_polias_Controls_'
    +'pOnDrawingViewSizeChanged',
  pAppOnCreate name 'Java_org_lamw_polias_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_polias_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_polias_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_polias_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_polias_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_polias_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_polias_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_polias_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_polias_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_polias_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_polias_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_polias_Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_polias_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 
    'Java_org_lamw_polias_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_polias_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_polias_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_polias_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_polias_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_polias_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_polias_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_polias_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_polias_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_polias_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 
    'Java_org_lamw_polias_Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_polias_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_polias_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_polias_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_polias_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_polias_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_polias_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_polias_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_polias_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_polias_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_polias_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_polias_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_polias_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_polias_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_polias_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_polias_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_polias_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_polias_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 
    'Java_org_lamw_polias_Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_polias_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_polias_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_polias_Controls_pOnRunOnUiThread',
  pEditTextOnActionIconTouchUp name 'Java_org_lamw_polias_Controls_'
    +'pEditTextOnActionIconTouchUp',
  pEditTextOnActionIconTouchDown name 'Java_org_lamw_polias_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.polias';
  gjClassName:= 'org/lamw/polias/Controls';
