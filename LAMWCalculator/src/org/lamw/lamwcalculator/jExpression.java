package org.lamw.lamwcalculator;
   ...
   /*.*/public void AddVariables(String[] _variables) {
    ...
    public void SetFormula(String _expression, String[] _variables) {
        try {
            ...
            mExpr = null;
            Toast toast = Toast.makeText(controls.activity, "Exception on Builder!"/*e.getMessage()*/, Toast.LENGTH_LONG);
            if (toast != null) {
                //toast.setGravity(Gravity.BOTTOM, 0, 0);
                toast.show();
            }
            Log.e("LAMW", "Exception on Builder!", e);
        }
    }
